...
pixi add digitalearth digitalearth-3d
# for installing globally
pixi global install digitalearth digitalearth-3d
```
...
It is possible to list all of the versions of `digitalearth` available on your platform:
...
```
pixi search digitalearth --channel conda-forge
```
